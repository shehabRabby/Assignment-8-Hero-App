...
const Home = () => {
  ...
  return (
    <div>
        ...
        <div className="container mx-auto text-center mt-12 px-3 md:px-1">
            ...
            <div className="flex justify-center gap-3">
                ...
                <button className="flex border-1 border-gray-400 px-4 py-1 rounded items-center"> <span className="mr-2" ><img src={appStore} alt="" /></span> Google Pay</button>
            </div>
        ...
        <div className="bg-gradient-to-r from-[#632EE3] to-[#9F62F2]">
            <div className="container mx-auto text-center text-white py-15">
                <div>
                    <p className="text-2xl md:text-4xl font-extrabold px-2" >Trusted By Millions, Built For You</p>
                </div>
